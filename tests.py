...
def test_add_new_book_added_correctly(books_collector):
...
def test_set_book_genre_added_correctly(books_collector):
...
def test_get_book_genre_correctly(books_collector):
...
def test_get_books_with_specific_genre_correctly(books_collector, name, genre):
    books_collector.add_new_book('Рождество на Ганимеде')
    books_collector.set_book_genre('Рождество на Ганимеде', 'Фантастика')
    books_collector.add_new_book('Рождество без Родни')
    books_collector.set_book_genre('Рождество без Родни', 'Фантастика')
...
def test_get_books_genre_correctly(books_collector, name, genre):
...
def test_get_books_for_children_returns_correctly(books_collector):
...
def test_add_book_in_favorites_added_correctly(books_collector):
    books_collector.add_new_book('Винни-Пух')
    books_collector.set_book_genre('Винни-Пух', 'Мультфильмы')
...
def test_delete_book_from_favorites_deleted_correctly(books_collector):
    books_collector.add_new_book('Винни-Пух')
    books_collector.set_book_genre('Винни-Пух', 'Мультфильмы')
    books_collector.add_book_in_favorites('Винни-Пух')
...
@pytest.mark.parametrize('name, genre', [
    ('Рождество на Ганимеде', 'Фантастика'),
    ('Рождество без Родни', 'Фантастика'), ('Приключения рождественского пудинга', 'Детективы')])
def test_get_list_of_favorites_books_added_corretly(books_collector, name, genre):
    books_collector.add_new_book(name)
    books_collector.set_book_genre(name, genre)
